...
const Header = ({siteTitle}) => {
  ...
  return (
    <header>
      <div onClick={showMenu} className={openState ? 'hambugerModal' : 'hambugerModal off' }></div>
    ...
    <Link to = '/'> 
      ...
      <div className={openState ? 'navHolder' : 'navHolder off' }>
        ...
        <div className="headerLink">
          <Link onClick={showMenu} to = '/#AboutMe' > About Me </Link>
          <Link onClick={showMenu} to = '/#mySkills' > My Skills </Link>
          <Link onClick={showMenu} href='/projects/projectListing' > My Projects </Link>
        </div>
      ...
      <div className='iconHolder'>
          ...
          <div className= 'hambugerHolder'>
            <div onClick={showMenu} className={openState ? 'hambuger open' : 'hambuger' }>
              <span></span>
              <span></span>
              <span></span>
            </div>
